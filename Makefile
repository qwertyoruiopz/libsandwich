...
ARM-CFLAGS	:= -dynamiclib -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -Fbinaries/System/Library/PrivateFrameworks/ -c -I include/ -I include/SAObjects/ -I include/Assistant -I. -g
